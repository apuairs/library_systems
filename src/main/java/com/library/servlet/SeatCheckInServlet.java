// servlet/SeatCheckInServlet.java
...
@WebServlet("/seatCheckIn")
public class SeatCheckInServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
        ...
        try {
            boolean success = seatService.checkIn(reservationId);
            if (success) {
