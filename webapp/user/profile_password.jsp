        ...
        <div class="container">
            ...
            <div class="profile-container">
                <div class="nav-tabs">
                    ...
                    <button class="nav-tab active" onclick="location.href='<%= request.getContextPath() %>/profile?action=password'">修改密码</button>
